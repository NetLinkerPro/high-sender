...
namespace NetLinker\HighSender\Sections\SmtpAccounts\Models;
...
class SmtpAccount extends Model implements OwnableContract
{
    ...
    {
        return config('high-sender.owner.model');
    }
     ...
     * @var string
     */
    protected $table = 'high_sender_smtp_accounts';
     ...
     * @var array
     */
    public $fillable = ['uuid', 'owner_uuid', 'name', 'host', 'port', 'username', 'password', 'encryption', 'from_name', 'from_address'];
